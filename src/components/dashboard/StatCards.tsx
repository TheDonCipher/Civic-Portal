  ...
  stats = {
    ...
    engagementStats: {
      ...
      trendingIssues: [
        ...
        { title: "Park Cleanup", category: "Environment", engagement: 72 },
        { title: "Street Lighting", category: "Safety", engagement: 64 },
        { title: "Community Center", category: "Community", engagement: 58 },
        { title: "Traffic Signal", category: "Infrastructure", engagement: 52 },
      ],
    },
    fundingStats: {
      totalRaised: 125000,
      ...
      recentDonations: [
        ...
        { amount: 2500, project: "Park Equipment", date: "2024-03-21" },
        { amount: 1000, project: "Street Lighting", date: "2024-03-21" },
        { amount: 3500, project: "Road Repair Equipment", date: "2024-03-20" },
        {
          amount: 1500,
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <ScrollArea className="h-[180px]">
              <div className="space-y-2">
                {stats.constituencyRankings.map((constituency, i) => (
                  <motion.div
                    key={i}
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold">
                  {stats.engagementStats.commentsPerIssue}
                </span>
              </div>
              <ScrollArea className="h-[180px]">
                <div className="space-y-2">
                  {stats.engagementStats.trendingIssues.map((issue, i) => (
                    <motion.div
                      key={i}
                      initial={{ opacity: 0, x: -20 }}
                      animate={{ opacity: 1, x: 0 }}
              ...
              <div className="p-4 rounded-lg bg-primary/5">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="font-semibold text-green-500">
                    {stats.fundingStats.totalRaised.toLocaleString()} BWP
                  </span>
                </div>
                <Progress
                  value={
                    (stats.fundingStats.totalRaised /
                      stats.fundingStats.targetAmount) *
                    100
                  }
                  className="h-2"
                />
                <p className="text-sm text-muted-foreground mt-2">
                  Target: {stats.fundingStats.targetAmount.toLocaleString()} BWP
                </p>
              </div>
              <ScrollArea className="h-[120px]">
                <div className="space-y-2">
                  {stats.fundingStats.recentDonations.map((donation, i) => (
                    <motion.div
                      key={i}
                      initial={{ opacity: 0, x: 20 }}
                      animate={{ opacity: 1, x: 0 }}
