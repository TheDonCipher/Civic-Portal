...
import { useRealtimeReports, TimeframeType } from "@/hooks/useRealtimeReports";
...
export const ReportsPageWithRealtimeHook = () => {
  ...
  React.useEffect(() => {
    ...
    const totalIssues =
      reportData.issuesByCategory?.reduce(
    ...
    const resolvedIssues =
      reportData.issuesByStatus?.find(
    ...
    const lastEngagementItem =
      reportData.citizenEngagement?.length > 0
        ? reportData.citizenEngagement[reportData.citizenEngagement.length - 1]
        : null;
  ...
  return (
    <MainLayout>
      <SEOHead
        ...
        description="View detailed reports and analytics about civic issues and government response with real-time updates."
      />
      <div className="max-w-[1800px] mx-auto p-6 space-y-6">
        <PageTitle
          title="Government Analytics Dashboard (Realtime)"
          description="Comprehensive analytics and reporting on civic issues and government response with real-time updates"
        />
